...
//////#define LCD_SDA        	//PA7    	// SPI 数据引脚
//////#define LCD_SCL        	//PA5    	// SPI 时钟引脚
//////#define LCD_CS        	//PA4    	// SPI片选引脚
//////#define LCD_DC         	//PB11    	// SPI 数据/命令引脚
//////#define LCD_RST           //PB10    	// 屏幕复位引脚 
//////#define LCD_BLK           //PB1    	// 背光控制引脚

//屏幕控制口置1操作语句宏定义
#define	GPIO_SPI_SDA_SET  	GPIO_SetBits(GPIOA, GPIO_Pin_7)
#define	GPIO_SPI_SCL_SET  	GPIO_SetBits(GPIOA, GPIO_Pin_5)

#define	GPIO_SPI_CS_SET  	GPIO_SetBits(GPIOA, GPIO_Pin_4)   
...
//屏幕控制口置0操作语句宏定义
#define	GPIO_SPI_SDA_CLR  	GPIO_ResetBits(GPIOA, GPIO_Pin_7)    
#define	GPIO_SPI_SCL_CLR  	GPIO_ResetBits(GPIOA, GPIO_Pin_5)  

#define	GPIO_SPI_CS_CLR  	GPIO_ResetBits(GPIOA, GPIO_Pin_4)  
