#ifndef __ST7789_HAL_SPI1_H__
#define __ST7789_HAL_SPI1_H__

#include "stdint.h"
#include "stm32f4xx_dma.h"

#define USE_DMA_SPI1                  1
...
//屏幕控制口置1操作语句宏定义
#define	HAL_SPI_CS_SET  	GPIO_SetBits(GPIOA, GPIO_Pin_4)   
#define	HAL_SPI_DC_SET  	GPIO_SetBits(GPIOB, GPIO_Pin_11)
#define HAL_SPI_RST_SET     GPIO_SetBits(GPIOB, GPIO_Pin_10)
#define	HAL_SPI_BLK_SET  	GPIO_SetBits(GPIOB, GPIO_Pin_1)
//屏幕控制口置0操作语句宏定义    
#define	HAL_SPI_CS_CLR  	GPIO_ResetBits(GPIOA, GPIO_Pin_4)  
#define	HAL_SPI_DC_CLR  	GPIO_ResetBits(GPIOB, GPIO_Pin_11) 
#define HAL_SPI_RST_CLR     GPIO_ResetBits(GPIOB, GPIO_Pin_10)
#define	HAL_SPI_BLK_CLR  	GPIO_ResetBits(GPIOB, GPIO_Pin_1)

void hal_spi1_gpio_init(void);	 //初始化SPI口
